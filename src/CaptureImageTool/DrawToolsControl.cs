...
namespace CSharpWin_JD.CaptureImage
{
    ...
    public partial class DrawToolsControl : UserControl
    {
        ...
        private static readonly object EventButtonZhiDingClick = new object();
        ...
        public event EventHandler ZhiDingBtnClick {
            add { base.Events.AddHandler(EventButtonZhiDingClick, value); }
            remove { base.Events.RemoveHandler(EventButtonZhiDingClick, value); }
        }
        ...
        private void zhiding_Btn_Click(object sender, EventArgs e) {
            EventHandler handler =
                base.Events[EventButtonZhiDingClick] as EventHandler;
            if (handler != null) {
                handler(this, e);
            }
        }
